...
@author: Chris Kidney
	     Student ID: 3251456
@date: Oct 16th, 2018
Class Description: Contains routines for displaying menus and controlling user input.
*/
#include "spacegame.h"
...
void gameoverScreen() {
	...
	textprintf_centre_ex(screen, font, SCREEN_W / 2 - 50, SCREEN_H / 2 - 25, WHITE, -1, "Final Score: ");
	textprintf_centre_ex(screen, font, SCREEN_W / 2, SCREEN_H / 2 - 25, WHITE, -1, con);
